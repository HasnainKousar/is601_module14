...
"""
JWT authentication and password management utilities for FastAPI.

Provides functions for password hashing, token creation, decoding, verification,
and user retrieval from JWT tokens. Integrates with Redis for token blacklisting.
"""
...
async def get_current_user(
    ...
    """
    Retrieve the current user from the JWT access token and database.
    """
    try:
